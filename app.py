...
SQLALCHEMY_DATABASE_URI = 'sqlite:///C:/Users/Anusha/Documents/xammm/htdocs/fishtail_warehouse/Billing_System/database.db'
...
def get_conversion_factor(product_name):
    ...
    return jsonify({'conversion_factor': None})
